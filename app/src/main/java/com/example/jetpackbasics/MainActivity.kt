...
import com.example.jetpackbasics.models.Name
...
fun CourseItem(course: Course, modifier: Modifier =Modifier){
    ...
    Column(modifier = modifier ) {
        ...
        Text(text = "Held by ${course.teacher?.address?.fullName}", fontSize = 20.sp, fontStyle = FontStyle.Italic)
        Spacer(modifier = Modifier.height(8.dp))
        Text(text = "Enrolled Students:${course.enrolledStudents.joinToString { it.name }}", fontSize = 10.sp)
